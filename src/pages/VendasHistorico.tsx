...
interface Venda {
  ...
  /** Só o nome: a lista mostra e filtra por ele. Telefone e CPF saíram daqui
   *  em 28/08, quando a ficha passou a buscar o cabeçalho sozinha — a lista
   *  baixava o contato de até 500 clientes que ninguém lia.
   *
   *  Cuidado que fica: a coluna do telefone chama `telefones`, no plural.
   *  Pedir `telefone` derruba a consulta INTEIRA, e a tela fica vazia como se
   *  a loja não tivesse vendido nada — foi o que aconteceu entre 25 e 27/08. */
...
export default function VendasHistorico() {
  ...
  // So o id: a ficha busca o resto sozinha. Guardar o objeto da lista
  // convidaria a ficha a depender de campos que so esta tela carrega —
  // foi exatamente isso que impediu de reaproveitá-la em Pagamentos.
  ...
  return (
    <div className="mx-auto max-w-5xl">
      ...
      */}
      ...
      {/* A ficha e a mesma que abre em Pagamentos e no Relatorio de
          Vendas -- ela busca tudo pelo id, ver components/vendas/FichaDaVenda. */}
